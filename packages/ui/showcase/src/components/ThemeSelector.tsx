...
export default function ThemeSelector() {
  ...
  const themes = [
    ...
    { value: "pixelato", label: "Pixelato", description: "Pixel art inspired theme" },
    { value: "win95", label: "Windows 95", description: "Retro Windows 95 style" }
  ]
  ...
  return (
    <div class="w-52">
      <Select
        ...
        value={currentTheme()}
        onChange={(value) => setTheme(value as "main" | "pixelato" | "win95")}
        itemComponent={(props) => {
      ...
      >
        <SelectTrigger>
          <SelectValue<string>>{(state) => {
            const theme = themes.find(t => t.value === state.selectedOption())
