    ...
    <div class="max-w-4xl">
      <div class="mb-8">
        ...
        <p class="text-xl text-gray-600">
          Interactive slider component for selecting numeric values within a range.
        </p>
      </div>
        ...
        <div class="space-y-6">
          <div class="flex items-center space-x-4">
            <svg class="w-5 h-5 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M9.383 3.076A1 1 0 0110 4v12a1 1 0 01-1.617.793L4.35 13.3a.5.5 0 00-.375-.175H2.5A1.5 1.5 0 011 11.625v-3.25A1.5 1.5 0 012.5 7h1.475a.5.5 0 00.375-.175l4.033-3.493zM14.5 7a.5.5 0 01.5.5v5a.5.5 0 01-1 0v-5a.5.5 0 01.5-.5z" clip-rule="evenodd" />
          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            <h4 class="text-sm font-medium text-gray-700 mb-2">Audio Settings</h4>
            <div class="space-y-3">
              ...
              <div class="flex items-center justify-between">
                ...
                <span class={`text-sm font-medium ${value3() > 0 ? 'text-green-600' : 'text-red-600'}`}>
