        ...
        <Tabs>
          ...
          <TabPanel>
            <div class="p-4">
              ...
              <p class="text-gray-600">Welcome to your dashboard overview. Here you can see a summary of your account activity.</p>
            </div>
          </TabPanel>
          <TabPanel>
            <div class="p-4">
              <h3 class="font-semibold text-gray-900 mb-2">Analytics</h3>
              <p class="text-gray-600">View detailed analytics and performance metrics for your account.</p>
            </div>
          </TabPanel>
          <TabPanel>
            <div class="p-4">
          ...
          <TabPanel>
            <div class="p-4 space-y-4">
              <div>
                ...
                <input type="text" class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2" placeholder="John Doe" />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700">Email</label>
                <input type="email" class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2" placeholder="john@example.com" />
              </div>
            </div>
          </TabPanel>
          <TabPanel>
            <div class="p-4 space-y-4">
              <div class="flex items-center justify-between">
                ...
                <button class="px-4 py-2 bg-indigo-600 text-white rounded-md text-sm">Enable</button>
              </div>
              <div class="flex items-center justify-between">
                <div>
                  <div class="font-medium">Password</div>
                  <div class="text-sm text-gray-500">Last updated 30 days ago</div>
                </div>
                <button class="px-4 py-2 border border-gray-300 rounded-md text-sm">Change</button>
              </div>
            </div>
          </TabPanel>
          <TabPanel>
