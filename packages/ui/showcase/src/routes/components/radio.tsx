  ...
  return (
    <div class="max-w-4xl">
      ...
      >
        <div class="space-y-4">
          <div>
            <div class="text-sm font-medium text-gray-700 mb-2">Select Size:</div>
            <div class="space-y-2">
              <Radio
                name="size"
                value="small"
      ...
      >
        <div class="space-y-2">
          <Radio name="states" checked={false}>
            Normal
          </Radio>
          <Radio name="states" checked={true}>
            Selected
          </Radio>
          <Radio name="states" checked={false} disabled>
            Disabled
          </Radio>
          <Radio name="states" checked={true} disabled>
            Selected & Disabled
          </Radio>
        </div>
      </ComponentDemo>
      ...
      >
        <div class="space-y-4">
          <div>
            <div class="text-sm font-medium text-gray-700 mb-3">Choose Color:</div>
            <div class="space-y-2">
              {[
                ...
                <div class="flex items-center space-x-3">
                  ...
                  >
                    <div class="flex items-center space-x-2">
                      <div class={`w-4 h-4 rounded-full ${color.color}`}></div>
          ...
          <div class="space-y-3">
            {[
              ...
              },
              {
                ...
                name: 'Enterprise',
                price: '$99/month',
                features: ['100 GB Storage', '24/7 Support', 'Advanced Analytics', 'Custom Integration']
              }
            ].map((plan) => (
                ...
                >
                  <div class="ml-3">
                    <div class="flex items-center justify-between">
                      ...
                      <div class="text-sm font-semibold text-gray-900">{plan.price}</div>
                    </div>
