  ...
  return (
    <label class="relative inline-flex items-center justify-between">
      <span class="cursor-pointer">
        ...
        />
        <div class="relative bg-shade-5 border-1 border-solid border-accent w-5 h-5 rounded-[50%] before:content-[] before:w-4 before:h-4 before:bg-accent before:opacity-0 peer-checked:before:opacity-100 before:rounded-full before:absolute before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2" />
      </span>
