    ...
    <SelectPrimitive.Trigger
      class={cn(
        local.variant !== "unstyled" &&
          "flex h-9 w-full items-center justify-between rounded-md border border-darkSlate-600 bg-darkSlate-800 px-3 py-2 text-sm text-lightSlate-100 shadow-sm ring-offset-darkSlate-900 transition-shadow placeholder:text-darkSlate-400 focus:outline-none focus-visible:ring-[1.5px] focus-visible:ring-primary-500 disabled:cursor-not-allowed disabled:opacity-50",
