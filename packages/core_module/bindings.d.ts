...
export type ListInstance = { id: FEInstanceId; group_id: FEGroupId; index: number; name: string; favorite: boolean; status: ListInstanceStatus; icon_revision: number | null; last_played: string | null; date_created: string; date_updated: string; seconds_played: number; locked: boolean }
