...
export type Procedures = {
  queries:
    ...
    | {
        key: "instance.getInstancesUngrouped";
        input: never;
        result: UngroupedInstance[];
      }
    ...
    | {
        key: "java.getSystemJavaProfiles";
        input: never;
        result: FESystemJavaProfile[];
      }
  ...
  mutations:
    ...
    | {
        key: "java.updateSystemJavaProfilePath";
        input: FEUpdateSystemJavaProfileArgs;
        result: null;
      }
...
export type FESystemJavaProfileName =
  | "legacy"
  | "alpha"
  | "beta"
  | "gamma"
...
export type FEUpdateSystemJavaProfileArgs = {
  profileName: FESystemJavaProfileName;
  javaId: string;
};
...
export type UngroupedInstance = {
  id: FEInstanceId;
  name: string;
  favorite: boolean;
  status: ListInstanceStatus;
  icon_revision: number;
} & { favorite: boolean };
...
export type LaunchState =
  | { Inactive: { failed_task: FETaskId | null } }
  | { Preparing: FETaskId }
  | { Running: { start_time: string; log_id: number } };

export type UpdateInstance = {
  instance: FEInstanceId;
  name?: Set<string> | null;
  use_loaded_icon?: Set<boolean> | null;
  notes?: Set<string> | null;
  version?: Set<string> | null;
  modloader?: Set<ModLoader | null> | null;
  global_java_args?: Set<boolean> | null;
  extra_java_args?: Set<string | null> | null;
...
export type Translation =
  | { translation: "ModCacheTaskUpdate" }
  | { translation: "ModCacheTaskUpdateScanFiles" }
  | { translation: "ModCacheTaskUpdateQueryApis" }
  | { translation: "InstanceTaskLaunch"; args: { name: string } }
  | { translation: "InstanceTaskPrepare"; args: { name: string } }
  | { translation: "InstanceTaskLaunchWaiting" }
  ...
  | { translation: "InstanceTaskLaunchDownloadAddonMetadata" }
...
export type FESystemJavaProfile = {
...
export type FESettings = {
  ...
  autoManageJava: boolean;
  preferredModChannel: ModChannel;
...
export type ValidListInstance = {
  ...
  modpack_platform: ModpackPlatform | null;
  state: LaunchState;
};
...
export type FESettingsUpdate = {
  ...
  discordIntegration?: boolean | null;
  releaseChannel?: FEReleaseChannel | null;
  concurrentDownloads?: number | null;
  showNews?: boolean | null;
  xmx?: number | null;
  xms?: number | null;
  isFirstLaunch?: boolean | null;
  startupResolution?: string | null;
  javaCustomArgs?: string | null;
  autoManageJava?: boolean | null;
  preferredModChannel?: ModChannel | null;
  termsAndPrivacyAccepted?: boolean | null;
