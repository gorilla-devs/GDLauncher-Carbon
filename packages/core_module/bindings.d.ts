...
export type Procedures = {
    queries: 
        ...
        { key: "instance.getModChannels", input: FEInstanceId, result: PlatformModChannel[] } | 
...
export type PlatformModChannel = { Curseforge: ModChannel } | { Modrinth: ModChannel }
