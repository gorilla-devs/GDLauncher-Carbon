...
export type Procedures = {
  queries:
    ...
    | {
        key: "modplatforms.curseforgeGetCategories";
        input: never;
        result: FECategoriesResponse;
      }
    | {
        key: "modplatforms.curseforgeGetFiles";
        input: FEFilesParameters;
        result: FEFilesResponse;
      }
    | {
        key: "modplatforms.curseforgeGetMod";
        input: FEModParameters;
        result: FEModResponse;
      }
    | {
        key: "modplatforms.curseforgeGetModDescription";
        input: FEModDescriptionParameters;
        result: FEModDescriptionResponse;
      }
    | {
        key: "modplatforms.curseforgeGetModFile";
        input: FEModFileParameters;
        result: FEModFileResponse;
      }
    | {
        key: "modplatforms.curseforgeGetModFileChangelog";
        input: FEModFileChangelogParameters;
        result: FEModFileChangelogResponse;
      }
    | {
        key: "modplatforms.curseforgeGetModFiles";
        input: FEModFilesParameters;
        result: FEModFilesResponse;
      }
    | {
        key: "modplatforms.curseforgeGetMods";
        input: FEModsParameters;
        result: FEModsResponse;
      }
    | {
        key: "modplatforms.curseforgeSearch";
        input: FEModSearchParameters;
        result: FEModSearchResponse;
      }
    | {
        key: "modplatforms.modrinthGetCategories";
        input: never;
        result: FEModrinthCategoriesResponse;
      }
    | {
        key: "modplatforms.modrinthGetProject";
        input: FEModrinthProjectID;
        result: FEModrinthProject;
      }
    | {
        key: "modplatforms.modrinthGetProjects";
        input: FEModrinthProjectIDs;
        result: FEModrinthProjectsResponse;
      }
    | {
        key: "modplatforms.modrinthGetVersion";
        input: FEModrinthVersionID;
        result: FEModrinthVersion;
      }
    | {
        key: "modplatforms.modrinthGetVersions";
        input: FEModrinthVersionIDs;
        result: FEModrinthVersionsResponse;
      }
    | {
        key: "modplatforms.modrinthSearch";
        input: FEModrinthProjectSearchParameters;
        result: FEModrinthProjectSearchResponse;
      }
    | {
...
export type FEModrinthCategory = {
  icon: string;
  name: string;
  project_type: FEModrinthProjectType;
  header: string;
};
...
export type FEModrinthSearchFacet =
  | { Category: string }
  | { Version: string }
  | { License: string }
  | { ProjectType: string };

export type FEModrinthDependency = {
  version_id: string | null;
  project_id: string | null;
  file_name: string | null;
  dependency_type: FEModrinthDependencyType;
};
...
export type FEUnifiedSearchParameters = {
  ...
  categories: And<string> | null;
  gameVersions: Or<string> | null;
  modloaders: Or<FEQueryModLoaderType> | null;
  projectType: FEUnifiedSearchType | null;
  sortIndex: FEUnifiedModSortIndex | null;
  sortOrder: FEModSearchSortOrder | null;
  index: number | null;
...
export type FEModSearchParametersQuery = {
  gameId: number;
  searchFilter: string | null;
  gameVersion: string | null;
  categoryId: number | null;
  sortOrder: FEModSearchSortOrder | null;
  sortField: FEModSearchSortField | null;
  classId: FEClassId | null;
  modLoaderType: FEModLoaderType | null;
...
export type FEModrinthProject = {
  ...
  description: string;
  categories: string[];
  client_side: FEModrinthProjectSupportRange;
  server_side: FEModrinthProjectSupportRange;
  body: string;
  ...
  donation_urls: FEModrinthDonationLink[];
  project_type: FEModrinthProjectType;
  downloads: number;
  ...
  id: string;
  team: string;
  moderator_message: FEModrinthModeratorMessage | null;
  published: string;
  updated: string;
  approved: string | null;
  followers: number;
  status: FEModrinthProjectStatus;
  license: FEModrinthLicense;
  versions: string[];
  game_versions: string[];
  loaders: string[];
  gallery: FEModrinthGalleryItem[];
};
...
export type FECategoriesResponse = {
  data: FECategory[];
  pagination: FEPagination | null;
};

export type FEModrinthProjectSearchParameters = {
  query: string | null;
  facets: FEModrinthSearchFacetAnd | null;
  index: FEModrinthSearchIndex | null;
  offset: number | null;
  limit: number | null;
  filters: string | null;
};
...
export type FEModrinthVersionFile = {
  hashes: FEModrinthHashes;
  url: string;
  filename: string;
  primary: boolean;
  size: number;
  file_type: FEModrinthAdditionalFileType | null;
};
...
export type FEModrinthAdditionalFileType =
  | "requiredResourcePack"
  | "optionalResourcePack";

export type CurseforgeModpack = { project_id: number; file_id: number };

export type FEModrinthDependencyType =
  | "required"
  | "optional"
  | "incompatible"
  | "embedded";
...
export type FEModFilesParametersQuery = {
  gameVersion?: string | null;
  modLoaderType?: FEModLoaderType | null;
  gameVersionTypeId?: number | null;
  index?: number | null;
...
export type FEModrinthHashes = { [key: string]: string } & {
  sha512: string;
  sha1: string;
};
...
export type FEFileIndex = {
  gameVersion: string;
  fileId: number;
  filename: string;
  releaseType: FEFileReleaseType;
  gameVersionTypeId: number | null;
  modLoader: FEModLoaderType | null;
};
...
export type FEMod = {
  ...
  authors: FEModAuthor[];
  logo: FEModAsset;
  screenshots: FEModAsset[];
  mainFileId: number;
  latestFiles: FEFile[];
  latestFilesIndexes: FEFileIndex[];
  dateCreated: string;
  dateModified: string;
  dateReleased: string;
...
export type FEModrinthRequestedVersionStatus =
  | "listed"
  | "archived"
  | "draft"
  | "unlisted";
...
export type FEFile = {
  ...
  gameVersions: string[];
  sortableGameVersions: FESortableGameVersion[];
  dependencies: FEFileDependency[];
...
export type FEModrinthSearchIndex =
  | "relevance"
  | "downloads"
  | "follows"
  | "newest"
...
export type FEFileRelationType =
  | "embeddedLibrary"
  | "optionalDependency"
  | "requiredDependency"
  | "tool"
...
export type ModFileMetadata = {
  ...
  authors: string | null;
  modloaders: ModLoaderType[] | null;
};

export type FEModSearchSortOrder = "ascending" | "descending";

export type FEModSearchSortField =
  | "featured"
  | "popularity"
  | "lastUpdated"
  | "name"
...
export type FESettingsUpdate = {
  ...
  isLegalAccepted?: boolean | null;
  metricsLevel?: number | null;
};
...
export type Translation =
  ...
  | { translation: "InstanceTaskLaunchInstallJava" }
...
export type FEFileDependency = {
  modId: number;
  relationType: FEFileRelationType;
};
...
export type FEModrinthModeratorMessage = {
  message: string;
  body: string | null;
};
 ...
 */
export type FEModrinthGalleryItem = {
  url: string;
  featured: boolean;
  title: string | null;
  description: string | null;
...
export type FEModrinthDonationLink = {
  id: string;
  platform: string;
  url: string;
};
...
export type FEModFilesParameters = {
  modId: number;
  query: FEModFilesParametersQuery;
};
...
export type FEModrinthProjectType =
  | "mod"
  | "shader"
  | "modpack"
  | "resourcepack";
...
export type FEModrinthProjectStatus =
  | "approved"
  | "rejected"
  | "draft"
  | "unlisted"
...
export type FEModrinthProjectSearchResponse = {
  hits: FEModrinthProjectSearchResult[];
  offset: number;
  limit: number;
  total_hits: number;
};
...
export type FEModrinthVersion = {
  name: string;
  version_number: string;
  changelog: string | null;
  dependencies: FEModrinthDependency[];
  game_versions: string[];
  version_type: FEModrinthVersionType;
  loaders: string[];
  featured: boolean;
  status: FEModrinthStatus | null;
  requested_status: FEModrinthRequestedVersionStatus | null;
  id: string;
  project_id: string;
  author_id: string;
  date_published: string;
  downloads: number;
  files: FEModrinthVersionFile[];
};
...
export type FEUnifiedModSortIndex =
  | { curseForge: FEModSearchSortField }
  | { modrinth: FEModrinthSearchIndex };

export type FEModLinks = {
...
export type FESortableGameVersion = {
...
export type FEModrinthProjectSupportRange =
  | "required"
  | "optional"
  | "unsupported"
  | "unknown";
