...
export type Procedures = {
    queries: 
        ...
        { key: "instance.getModpackInfo", input: FEInstanceId | null, result: FEModpackInfo | null } | 
...
export type FEModpackInfo = { name: string; version_name: string; url_slug: string }
