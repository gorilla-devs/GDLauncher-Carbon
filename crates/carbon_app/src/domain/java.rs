...
impl TryFrom<carbon_repos::models::Java> for Java {
    type Error = anyhow::Error;

    fn try_from(value: carbon_repos::models::Java) -> Result<Self, Self::Error> {
...
impl TryFrom<carbon_repos::models::Java> for JavaComponent {
    type Error = anyhow::Error;
    ...
    fn try_from(value: carbon_repos::models::Java) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            _type: JavaComponentType::try_from(&*value.java_type)?,
...
impl SystemJavaProfileName {
    pub fn is_java_version_compatible(&self, java_version: &JavaVersion) -> bool {
        match self {
            ...
            Self::Epsilon => java_version.major == 25,
...
impl TryFrom<MinecraftJavaProfile> for SystemJavaProfileName {
    ...
    fn try_from(value: MinecraftJavaProfile) -> Result<Self, Self::Error> {
        match value {
            ...
            MinecraftJavaProfile::JavaRuntimeEpsilon => Ok(Self::Epsilon),
...
impl TryFrom<carbon_repos::models::JavaProfile> for JavaProfile {
    type Error = anyhow::Error;

    fn try_from(data: carbon_repos::models::JavaProfile) -> Result<Self, Self::Error> {
        Ok(Self {
            name: data.name,
