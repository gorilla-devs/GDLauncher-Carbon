...
CREATE TABLE "new_AppConfiguration" (
  ...
  CONSTRAINT "AppConfiguration_activeAccountUuid_fkey" FOREIGN KEY ("activeAccountUuid") REFERENCES "Account" ("uuid") ON DELETE
  SET
    NULL ON UPDATE CASCADE,
    CONSTRAINT "AppConfiguration_gdlAccountUuid_fkey" FOREIGN KEY ("gdlAccountUuid") REFERENCES "Account" ("uuid") ON DELETE
  SET
    NULL ON UPDATE CASCADE
);

INSERT INTO
  "new_AppConfiguration" (
    "activeAccountUuid",
...
ALTER TABLE
  "new_AppConfiguration" RENAME TO "AppConfiguration";
