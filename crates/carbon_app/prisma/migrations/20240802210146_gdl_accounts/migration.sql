...
CREATE TABLE "new_AppConfiguration" (
    ...
    "hasCompletedGDLAccountSetup" BOOLEAN NOT NULL DEFAULT false,
    "gdlAccountUuid" TEXT,
    ...
    CONSTRAINT "AppConfiguration_gdlAccountUuid_fkey" FOREIGN KEY ("gdlAccountUuid") REFERENCES "Account" ("uuid") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_AppConfiguration" ("activeAccountUuid", "autoManageJavaSystemProfiles", "concurrentDownloads", "defaultInstanceGroup", "deletionThroughRecycleBin", "discordIntegration", "downloadDependencies", "gameResolution", "id", "instancesGroupBy", "instancesGroupByAsc", "instancesSortBy", "instancesSortByAsc", "instancesTileSize", "isFirstLaunch", "javaCustomArgs", "language", "lastAppVersion", "launcherActionOnGameLaunch", "metricsEnabled", "metricsEnabledLastUpdate", "modChannels", "modPlatformBlacklist", "postExitHook", "preLaunchHook", "randomUserUuid", "reducedMotion", "releaseChannel", "secret", "showAppCloseWarning", "showNews", "termsAndPrivacyAccepted", "termsAndPrivacyAcceptedChecksum", "theme", "wrapperCommand", "xms", "xmx") SELECT "activeAccountUuid", "autoManageJavaSystemProfiles", "concurrentDownloads", "defaultInstanceGroup", "deletionThroughRecycleBin", "discordIntegration", "downloadDependencies", "gameResolution", "id", "instancesGroupBy", "instancesGroupByAsc", "instancesSortBy", "instancesSortByAsc", "instancesTileSize", "isFirstLaunch", "javaCustomArgs", "language", "lastAppVersion", "launcherActionOnGameLaunch", "metricsEnabled", "metricsEnabledLastUpdate", "modChannels", "modPlatformBlacklist", "postExitHook", "preLaunchHook", "randomUserUuid", "reducedMotion", "releaseChannel", "secret", "showAppCloseWarning", "showNews", "termsAndPrivacyAccepted", "termsAndPrivacyAcceptedChecksum", "theme", "wrapperCommand", "xms", "xmx" FROM "AppConfiguration";
