...
INSERT INTO "new_AppConfiguration" ("activeAccountUuid", "autoManageJava", "concurrentDownloads", "defaultInstanceGroup", "discordIntegration", "gameResolution", "id", "isFirstLaunch", "javaCustomArgs", "language", "launcherActionOnGameLaunch", "metricsEnabled", "metricsEnabledLastUpdate", "modChannels", "modPlatformBlacklist", "randomUserUuid", "reducedMotion", "releaseChannel", "secret", "showNews", "termsAndPrivacyAccepted", "termsAndPrivacyAcceptedChecksum", "theme", "xms", "xmx") SELECT "activeAccountUuid", "autoManageJava", "concurrentDownloads", "defaultInstanceGroup", "discordIntegration", "gameResolution", "id", "isFirstLaunch", "javaCustomArgs", "language", "launcherActionOnGameLaunch", "metricsEnabled", "metricsEnabledLastUpdate", "modChannels", "modPlatformBlacklist", "randomUserUuid", "reducedMotion", "releaseChannel", "secret", "showNews", "termsAndPrivacyAccepted", "termsAndPrivacyAcceptedChecksum", "theme", "xms", "xmx" FROM "AppConfiguration";
