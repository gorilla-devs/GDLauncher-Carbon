...
INSERT INTO "new_ModrinthModCache" ("authors", "cachedAt", "description", "fileUrl", "filename", "metadataId", "projectId", "sha512", "title", "urlslug", "versionId") SELECT "authors", "cachedAt", "description", "fileUrl", "filename", "metadataId", "projectId", "sha512", "title", "urlslug", "versionId" FROM "ModrinthModCache";
