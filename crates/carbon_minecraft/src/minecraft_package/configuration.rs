...
pub(crate) trait ConfigurationFileParser {
    async fn parse_from_file<T: AsRef<Path> + Sync>(configuration_file_path: &T) -> Result<MinecraftPackageConfigurationFile, ConfigurationFileParsingError> {
    ...
    async fn write_in_file<T: AsRef<Path> + Sync>(minecraft_package: &MinecraftPackage, configuration_file_path: &T) -> Result<MinecraftPackageConfigurationFile, ConfigurationFileParsingError> {
