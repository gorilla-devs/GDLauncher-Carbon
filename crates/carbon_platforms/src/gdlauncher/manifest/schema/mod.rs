...
type LatestInstanceConfig = v1::Manifest;

// pub async fn parse_and_update_instance_config(
//     config_str: &str,
//     config_path: PathBuf,
// ) -> anyhow::Result<LatestInstanceConfig> {
...
pub fn parse_instance_config(config_str: &str) -> Result<LatestInstanceConfig, serde_json::Error> {
...
pub fn make_instance_config(info: LatestInstanceConfig) -> Result<String, serde_json::Error> {
    serde_json::to_string_pretty(&InstanceConfig::V1(info))
}
