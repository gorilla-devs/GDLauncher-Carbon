...
Hello everyone! As some of you might know, we have been thinking on doing a rewrite of GDLauncher for a while, and we're here today to finally give you some updates!
...
For a long time I have been tanking all expenses and liabilities on myself, but this will finally change!
...
All the resources will go towards developing GDLauncher Carbon. We don't have an ETA yet, and we will publish updates in the next few weeks on our [Discord](https://discord.gdlauncher.com).
After GDLauncher Carbon is ready to go to production, the current release of GDLauncher will be completely archived.
...
<img
  src="https://edge.gdlauncher.com/articles/curseforge-partnership-announcement/polymc-mac.png"
  alt="PolyMC - Mac"
/>
...
<img
  src="https://edge.gdlauncher.com/articles/curseforge-partnership-announcement/polymc-win.png"
  alt="PolyMC - Windows"
/>
...
We are currently evaluating multiple options but we haven't decided yet, so if you have any ideas or suggestions, please let us know on our [Discord](https://discord.gdlauncher.com).
...
As a business, we will need to collect some data to be able to provide our services, but we will make sure that we are not collecting any data that is not necessary.
...
- Apply to our hiring selection at [here](https://gdlauncher.com/careers) to work with us full time! We are hiring designers as well as Rust and JavaScript engineers
