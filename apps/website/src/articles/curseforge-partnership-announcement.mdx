...
## Modrinth support
We were able to find an agreement with their team and GDLauncher will have first-class support for Modrinth!
You'll be able to install and browse mods and modpacks from both Curseforge and Modrinth in an easy way.
