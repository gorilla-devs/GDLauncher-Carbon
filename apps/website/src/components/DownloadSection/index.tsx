...
const DownloadSection: Component<{ pathname: string }> = ({ pathname }) => {
  ...
  return (
    <>
      ...
      >
        <div
          class={`relative flex flex-col justify-center items-center pt-1 box-border h-screen bg-[url("https://https://edge.gdlauncher.com/assets/mc_forest_2.webp")] bg-no-repeat`}
        >
