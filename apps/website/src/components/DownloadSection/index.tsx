...
const DownloadSection: Component<{ pathname: string }> = ({ pathname }) => {
  ...
  return (
    <div
      class={`relative flex flex-col justify-center items-center pt-1 box-border h-screen
bg-[url("https://cdn.gdlauncher.com/assets/mc_forest_2.webp")] bg-no-repeat`}
    >
      <div class="absolute top-0 bottom-0 left-0 right-0">
        <div class="absolute top-0 bottom-0 left-0 right-0 z-10 opacity-95 bg-slate-800"></div>
      </div>
      <div class="w-4/5 lg:w-full z-20 flex flex-col-reverse lg:flex-row justify-between items-center gap-20 max-w-7xl mt-10 sm:mt-60">
