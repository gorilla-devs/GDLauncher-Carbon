 ...
 * as `"Checked<id>"`. `allTextContents()` used to be exactly that raw text,
 * which silently broke the round trip back to `instance-creation-loader-
 * version-option-<id>` for whichever id happened to be pre-selected (always
