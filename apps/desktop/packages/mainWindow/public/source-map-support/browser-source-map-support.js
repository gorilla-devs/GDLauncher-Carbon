...
(
  this.define ||
  function (R, U) {
    this.sourceMapSupport = U();
  }
)("browser-source-map-support", function (R) {
  (function e(C, J, A) {
    function p(f, c) {
      if (!J[f]) {
        if (!C[f]) {
    ...
    for (
      var t = "function" == typeof require && require, m = 0;
      m < A.length;
      m++
    )
      p(A[m]);
        ...
        function (C, J, A) {
          (function (e) {
            ...
            e.toByteArray = function (m) {
              ...
              2 === l
                ? ((u = (p(m.charAt(c)) << 2) | (p(m.charAt(c + 1)) >> 4)),
                  f(u & 255))
                : 1 === l &&
                  ((u =
                    (p(m.charAt(c)) << 10) |
        ...
        function (C, J, A) {
          function e(a, b, h) {
            ...
            if ("number" === w) var y = 0 < a ? a >>> 0 : 0;
              ...
              if ("base64" === b)
                for (
                  a = (a.trim ? a.trim() : a.replace(/^\s+|\s+$/g, "")).replace(
                    L,
                    ""
                  );
                  0 !== a.length % 4;
                  ...
                  a += "=";
              y = e.byteLength(a, b);
            } else if ("object" === w && null !== a)
              "Buffer" === a.type && z(a.data) && (a = a.data),
                (y = 0 < +a.length ? Math.floor(+a.length) : 0);
            else
              throw new TypeError(
            ...
            if (e.TYPED_ARRAY_SUPPORT) var I = e._augment(new Uint8Array(y));
            else (I = this), (I.length = y), (I._isBuffer = !0);
            if (e.TYPED_ARRAY_SUPPORT && "number" === typeof a.byteLength)
              ...
              if (
                z(K) ||
                e.isBuffer(K) ||
                (K && "object" === typeof K && "number" === typeof K.length)
              )
                if (e.isBuffer(a))
                  for (b = 0; b < y; b++) I[b] = a.readUInt8(b);
                else for (b = 0; b < y; b++) I[b] = ((a[b] % 256) + 256) % 256;
              else if ("string" === w) I.write(a, 0, b);
              else if ("number" === w && !e.TYPED_ARRAY_SUPPORT && !h)
                for (b = 0; b < y; b++) I[b] = 0;
            }
            return I;
          }
          ...
          function m(a, b, h, w, y, I) {
            if (!e.isBuffer(a))
              throw new TypeError("buffer must be a Buffer instance");
            if (b > y || b < I) throw new TypeError("value is out of bounds");
            if (h + w > a.length) throw new TypeError("index out of range");
          }
          function f(a, b, h, w) {
            0 > b && (b = 65535 + b + 1);
          ...
          function q(a, b, h, w, y) {
            y || l(a, b, h, 4, 3.4028234663852886e38, -3.4028234663852886e38);
            v.write(a, b, h, w, 23, 4);
            return h + 4;
          }
          function r(a, b, h, w, y) {
            y || l(a, b, h, 8, 1.7976931348623157e308, -1.7976931348623157e308);
            v.write(a, b, h, w, 52, 8);
            return h + 8;
          }
          function k(a) {
            for (var b = [], h = 0; h < a.length; h++) {
              ...
              if (127 >= w) b.push(w);
                ...
                w = encodeURIComponent(a.slice(y, h + 1))
                  .substr(1)
                  .split("%");
                for (y = 0; y < w.length; y++) b.push(parseInt(w[y], 16));
              }
            }
            return b;
          }
          function u(a) {
            for (var b = [], h = 0; h < a.length; h++)
              b.push(a.charCodeAt(h) & 255);
            return b;
          }
          function d(a, b, h, w, y) {
            y && (w -= w % y);
            for (y = 0; y < w && !(y + h >= b.length || y >= a.length); y++)
              b[y + h] = a[y];
            return y;
          }
          function g(a) {
          ...
          e.compare = function (a, b) {
            if (!e.isBuffer(a) || !e.isBuffer(b))
              throw new TypeError("Arguments must be Buffers");
            for (
              var h = a.length, w = b.length, y = 0, I = Math.min(h, w);
              y < I && a[y] === b[y];
              y++
            );
            y !== I && ((h = a[y]), (w = b[y]));
              ...
              switch (a) {
                case "hex":
                  ...
                  for (h = a; h < b; h++)
                    (a = w),
                      (w = this[h]),
                      (w = 16 > w ? "0" + w.toString(16) : w.toString(16)),
                      (w = a + w);
                  return w;
                case "utf8":
                case "utf-8":
                  w = a = "";
                  for (h = Math.min(this.length, h); b < h; b++)
                    127 >= this[b]
                      ? ((a += g(w) + String.fromCharCode(this[b])), (w = ""))
                      : (w += "%" + this[b].toString(16));
                  return a + g(w);
                case "ascii":
                  return p(this, b, h);
                case "binary":
                  ...
                  return (
                    (b =
                      0 === b && h === this.length
                        ...
                        : n.fromByteArray(this.slice(b, h))),
                    b
                  );
                case "ucs2":
                case "ucs-2":
                ...
                case "utf-16le":
                  ...
                  for (a = 0; a < b.length; a += 2)
                    h += String.fromCharCode(b[a] + 256 * b[a + 1]);
                  return h;
                default:
          ...
          e.prototype.write = function (a, b, h, w) {
            if (isFinite(b)) isFinite(h) || ((w = h), (h = void 0));
            else {
              var y = w;
              w = b;
              b = h;
            ...
            switch (w) {
              case "hex":
                ...
                w = a.length;
                if (0 !== w % 2) throw Error("Invalid hex string");
                h > w / 2 && (h = w / 2);
                for (w = 0; w < h; w++) {
                  y = parseInt(a.substr(2 * w, 2), 16);
                  if (isNaN(y)) throw Error("Invalid hex string");
                  this[b + w] = y;
                }
                a = w;
                break;
          ...
          e.prototype.slice = function (a, b) {
            ...
            0 > b ? ((b += h), 0 > b && (b = 0)) : b > h && (b = h);
            b < a && (b = a);
            if (e.TYPED_ARRAY_SUPPORT) return e._augment(this.subarray(a, b));
            h = b - a;
            for (var w = new e(h, void 0, !0), y = 0; y < h; y++)
              w[y] = this[y + a];
            return w;
          };
