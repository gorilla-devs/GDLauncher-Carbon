  ...
  return (
    <div class="flex h-full flex-col">
      ...
      <div class="flex shrink-0 flex-col gap-4">
        <div class="mb-2 flex items-center gap-3">
          ...
          <h2 class="m-0 text-xl font-bold">
            <Trans key="instance:_trn_duplicates.summary.title" />
          </h2>
        </div>

        <p class="text-lightSlate-700 text-sm leading-6">
          <Trans key="instance:_trn_duplicates.summary.description" />
        </p>
        ...
        <div class="bg-darkSlate-600 mb-2 rounded-lg p-4">
          <div class="mb-3 flex items-center gap-2">
            ...
            <h3 class="m-0 text-sm font-semibold">
              <Trans key="instance:_trn_duplicates.summary.action_title" />
            </h3>
          </div>
          <p class="text-lightSlate-700 m-0 ml-6 text-sm">
            <Show
              ...
              fallback={
                <Trans key="instance:_trn_duplicates.summary.action_remove" />
              }
            >
              <Trans key="instance:_trn_duplicates.summary.action_disable" />
            </Show>
          </p>
        </div>
      </div>
                        ...
                        <div class="bg-darkSlate-800 mb-2 rounded p-2">
                          <div class="flex items-center gap-2 text-xs">
                            ...
                            <span class="text-green-400">
                              <Trans key="instance:_trn_duplicates.summary.status_keep" />
                            </span>
                          ...
                          <div class="text-lightSlate-600 flex items-center gap-2 text-xs">
                            ...
                            >
                              <Show
                                when={props.action === "disable"}
                                fallback={
                                  <Trans key="instance:_trn_duplicates.summary.status_remove" />
                                }
                              >
                                <Trans key="instance:_trn_duplicates.summary.status_disable" />
                              </Show>
                            </span>
      ...
      <div class="mt-6 flex shrink-0 justify-between">
        ...
        >
          <Trans key="instance:_trn_duplicates.summary.button_back" />
        </Button>
        <Button
          type="primary"
          size="large"
          ...
          disabled={props.isApplying}
        >
          <Trans key="instance:_trn_duplicates.summary.button_apply" />
        </Button>
      </div>
    </div>
  )
