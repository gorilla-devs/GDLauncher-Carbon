    ...
    <div class="flex h-full flex-col justify-between">
      <div class="flex flex-col gap-4">
        <div class="mb-2 flex items-center gap-3">
          ...
          <h2 class="m-0 text-xl font-bold">
            <Trans key="instance:_trn_duplicates.action.title" />
          </h2>
        </div>

        <p class="text-lightSlate-700 text-sm leading-6">
          <Trans key="instance:_trn_duplicates.action.question" />
        </p>
              ...
              <div class="flex w-full flex-col gap-2">
                <div class="flex items-center gap-2">
                  ...
                  <span class="font-semibold">
                    <Trans key="instance:_trn_duplicates.action.disable_title" />
                  </span>
                </div>
                <p class="text-lightSlate-600 m-0 ml-6 text-sm">
                  <Trans key="instance:_trn_duplicates.action.disable_description" />
                </p>
              </div>
            </Radio>
          </div>
            ...
            >
              <div class="flex w-full flex-col gap-2">
                <div class="flex items-center gap-2">
                  ...
                  <span class="font-semibold">
                    <Trans key="instance:_trn_duplicates.action.remove_title" />
                  </span>
                </div>
                <p class="text-lightSlate-600 m-0 ml-6 text-sm">
                  <Trans key="instance:_trn_duplicates.action.remove_description" />
                </p>
              </div>
            </Radio>
          </div>
      ...
      <div class="mt-6 flex justify-between">
        <Button type="secondary" size="large" onClick={() => props.prevStep()}>
          <Trans key="instance:_trn_duplicates.action.button_back" />
        </Button>
        <Button type="primary" size="large" onClick={() => props.nextStep()}>
          <Trans key="instance:_trn_duplicates.action.button_continue" />
        </Button>
      </div>
    </div>
  )
