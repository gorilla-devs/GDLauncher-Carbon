...
const ThirdStep = (props: Props) => {
  ...
  const CreateInstance = () => {
    return (
      <div class="flex flex-col items-center justify-between lg:w-160 lg:h-140 box-border">
  ...
  return (
    <div class="flex flex-col items-center justify-between w-120 h-120 lg:w-160 lg:h-140 box-border">
      <Switch>
