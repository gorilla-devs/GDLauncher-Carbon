...
const DuplicatedModsResolution = (props: ModalProps) => {
  ...
  const resolutionSteps = [
    {
      label: t("instance:_trn_duplicates.steps.introduction"),
      icon: <div>1</div>,
      onClick: () => {
        setCurrentStep(0)
    ...
    {
      label: t("instance:_trn_duplicates.steps.select_mods"),
      icon: <div>2</div>,
      onClick: () => {
        setCurrentStep(1)
    ...
    {
      label: t("instance:_trn_duplicates.steps.action"),
      icon: <div>3</div>,
      onClick: () => setCurrentStep(2)
    },
    {
      label: t("instance:_trn_duplicates.steps.summary"),
      icon: <div>4</div>,
