  ...
  return (
    <div class="flex flex-col gap-4">
      <div class="flex w-full flex-wrap justify-center gap-4">
        ...
        >
          <Card
            title={t("instance:_trn_overview_card_mods_title")}
        ...
        <Show when={routeData.instanceDetails.data?.secondsPlayed}>
          <Card
            title={t("instance:_trn_overview_card_played_time_title")}
            text={formatDuration(
              intervalToDuration({
                start: 0,
        ...
        <Show when={routeData.instanceDetails.data?.lastPlayed}>
          <Card
            title={t("instance:_trn_overview_card_last_played_title")}
            text={format(
            ...
            >
              <div class="z-10 flex w-full flex-col items-start justify-between gap-6 2xl:flex-row 2xl:items-center 2xl:gap-14">
                ...
                <div class="flex gap-4">
                  ...
                  >
                    <Trans key="instance:_trn_modpack_open_website" />
                  ...
                  >
                    <Trans key="instance:_trn_modpack_view" />
