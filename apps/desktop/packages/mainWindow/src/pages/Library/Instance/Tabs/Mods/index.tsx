      ...
      <div class="min-h-90 flex h-full w-full items-center justify-center">
        <div class="flex flex-col items-center justify-center gap-6 text-center">
          ...
          <p class="text-lightSlate-700 max-w-100">
            <Trans key="instance:_trn_no_mods_text" />
          </p>
          <Button
            type="outline"
            size="medium"
          ...
          >
            <Trans key="instance:_trn_add_mod" />
          </Button>
        </div>
      </div>
    )
      ...
      >
        <div class="flex h-full items-center">
          ...
          <div class="text-lightSlate-700">
            <Trans
              key="instance:_trn_instance_selected_mods_count"
              options={{
            ...
            <Tooltip placement="top">
              <TooltipTrigger>
                <div class="text-lightSlate-700 flex cursor-pointer items-center gap-2">
                  ...
                  <Trans key="instance:_trn_delete_mod" />
                </div>
              </TooltipTrigger>
              <TooltipContent class="max-w-38 overflow-hidden text-ellipsis">
                <Trans key="instance:_trn_locked_cannot_apply_changes" />
              ...
              <Tooltip placement="top">
                <TooltipTrigger>
                  <div class="text-lightSlate-700 flex items-center gap-2">
                    ...
                    <Trans key="instance:_trn_update_mods" />
                  </div>
                </TooltipTrigger>
                <TooltipContent class="max-w-38 overflow-hidden text-ellipsis">
                  <Trans key="instance:_trn_locked_cannot_apply_changes" />
        ...
        <div class="flex flex-wrap items-center justify-between gap-1 pb-4">
          <div class="flex cursor-pointer items-center gap-4">
            ...
            <Input
              ...
              placeholder={t("instance:_trn_mods.search")}
          ...
          <div class="flex items-center gap-4">
            {/* <p class="text-lightSlate-700">
              <Trans key="instance:_trn_sort_by" />
            </p>
            <Dropdown
              options={[
                { label: t("instance:_trn_sort_by_asc"), key: "_trn_asc" },
                { label: t("instance:_trn_sort_by_desc"), key: "_trn_desc" }
              ]}
              value={"asc"}
              rounded
            /> */}
            ...
            >
              <Tooltip placement="top">
                ...
                <TooltipContent class="max-w-38 overflow-hidden text-ellipsis">
                  ...
                  <Show when={!isInstanceLocked()}>
                    <Trans key="instance:_trn_update_all_mods" />
                  </Show>
                </TooltipContent>
              </Tooltip>
            </Show>
            ...
            <Tooltip placement="top">
              ...
              <TooltipContent class="max-w-38 overflow-hidden text-ellipsis">
                <Trans key="instance:_trn_open_mods_folder" />
              </TooltipContent>
            </Tooltip>
          </div>
        </div>
