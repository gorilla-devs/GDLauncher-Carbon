    ...
    <div class="min-h-90 flex h-full w-full items-center justify-center">
      <div class="flex flex-col items-center justify-center gap-6 text-center">
        ...
        <p class="text-lightSlate-700 max-w-100">
          <Trans
            key="instance:_trn_no_screenshots_text"
            options={{
              defaultValue:
        ...
        <div class="text-lightSlate-700 z-10 mb-5 flex justify-between">
          <div class="flex gap-4">
            <div class="flex cursor-pointer items-center gap-2">
              ...
              <Trans
                key="instance:_trn_select_all_screenshots"
                options={{
            ...
            <div class="hover:text-lightSlate-50 flex cursor-pointer items-center gap-2 transition duration-100 ease-in-out">
              ...
              <Trans
                key="instance:_trn_open_screenshots_folder"
                options={{
            ...
            <div class="hover:text-lightSlate-50 flex cursor-pointer items-center gap-2 transition duration-100 ease-in-out">
              ...
              <Trans
                key="instance:_trn_disable_screenshot"
                options={{
            ...
            <div class="hover:text-lightSlate-50 flex cursor-pointer items-center gap-2 transition duration-100 ease-in-out">
              ...
              <Trans
                key="instance:_trn_delete_screenshot"
                options={{
                  defaultValue: "delete"
                }}
              />
