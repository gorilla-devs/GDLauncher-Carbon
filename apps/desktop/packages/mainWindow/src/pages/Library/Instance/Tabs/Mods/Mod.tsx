...
//         <Trans
//           key="instance:_trn_update_available_from"
//           options={{
              ...
              <PopoverContent>
                ...
                >
                  <div class="text-lightSlate-50 mb-4 text-xl font-bold">
                    <Trans
                      key="instance:_trn_mods_technical_info_for"
                      options={{
                        mod_name:
                          props.mod.curseforge?.name ||
                          props.mod.metadata?.name ||
                  ...
                  <div class="flex w-full flex-col">
                    <div class="flex w-full justify-between text-sm">
                      <div class="w-50">
                        <Trans key="instance:_trn_id" />
                      </div>
                      <CopiableEntity text={props.mod.id} />
                    </div>
                    <div class="flex w-full justify-between text-sm">
                      <div class="w-50">
                        <Trans key="instance:_trn_file_name" />
                      </div>
                    ...
                    <Show when={props.mod.metadata}>
                      <div class="text-lightSlate-50 mt-4 text-xl">
                        <Trans key="instance:_trn_local_metadata" />
                      </div>
                      <div class="flex w-full justify-between text-sm">
                        <div class="w-50">
                          <Trans key="instance:_trn_metadata_id" />
                        </div>
                        <CopiableEntity text={props.mod.metadata?.id} />
                      </div>
                      <div class="flex w-full justify-between text-sm">
                        <div class="w-50">
                          <Trans key="instance:_trn_metadata_name" />
                        </div>
                        <CopiableEntity text={props.mod.metadata?.modid} />
                      </div>
                      <div class="flex w-full justify-between text-sm">
                        <div class="w-50">
                          <Trans key="instance:_trn_metadata_version" />
                        </div>
                        <CopiableEntity text={props.mod.metadata?.version} />
                      </div>
                      <div class="flex w-full justify-between text-sm">
                        <div class="w-50">
                          <Trans key="instance:_trn_metadata_sha_1" />
                        </div>
                        <CopiableEntity text={props.mod.metadata?.sha_1} />
                      </div>
                      <div class="flex w-full justify-between text-sm">
                        <div class="w-50">
                          <Trans key="instance:_trn_metadata_sha_512" />
                        </div>
                        <CopiableEntity text={props.mod.metadata?.sha_512} />
                      </div>
                      <div class="flex w-full justify-between text-sm">
                        <div class="w-50">
                          <Trans key="instance:_trn_metadata_murmur_2" />
                        </div>
                        <CopiableEntity text={props.mod.metadata?.murmur_2} />
                      </div>
                      <div class="flex w-full justify-between text-sm">
                        <div class="w-50">
                          <Trans key="instance:_trn_metadata_murmur_2_unsigned" />
                        </div>
                        <CopiableEntity text={unsigned_murmur2()} />
                      </div>
                      <div class="flex w-full justify-between text-sm">
                        <div class="w-50">
                          <Trans key="instance:_trn_metadata_modloaders" />
                        </div>
                    ...
                    <Show when={props.mod.curseforge}>
                      <div class="mt-4 flex items-center justify-between text-xl">
                        <div class="text-lightSlate-50 flex items-center">
                          <Trans key="instance:_trn_curseforge" />
                          <img src={CurseforgeLogo} class="ml-2 h-4 w-4" />
                        </div>
                      </div>
                      <div class="flex w-full justify-between text-sm">
                        <div class="w-50">
                          <Trans key="instance:_trn_curseforge_project_id" />
                        </div>
                        <CopiableEntity
                      ...
                      <div class="flex w-full justify-between text-sm">
                        <div class="w-50">
                          <Trans key="instance:_trn_curseforge_file_id" />
                        </div>
                      ...
                      <div class="my-4 flex w-full gap-4">
                        ...
                        >
                          <Trans key="instance:_trn_open_mod_page" />
                    ...
                    <Show when={props.mod.modrinth}>
                      <div class="mt-4 flex items-center justify-between text-xl">
                        <div class="text-lightSlate-50 flex items-center">
                          <Trans key="instance:_trn_modrinth" />
                          <img src={ModrinthLogo} class="ml-2 h-4 w-4" />
                        </div>
                      </div>
                      <div class="flex w-full justify-between text-sm">
                        <div class="w-50">
                          <Trans key="instance:_trn_modrinth_project_id" />
                        </div>
                        <CopiableEntity text={props.mod.modrinth?.project_id} />
                      </div>
                      <div class="flex w-full justify-between text-sm">
                        <div class="w-50">
                          <Trans key="instance:_trn_modrinth_version_id" />
                        </div>
