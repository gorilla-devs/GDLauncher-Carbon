...
const defaultColumns: ColumnDef<AccountEntry>[] = [
  {
    ...
    header: () => (
      <span>
        <Trans key="settings:_trn_active" />
      </span>
    )
  },
  {
    ...
    header: () => (
      <span>
        <Trans key="settings:_trn_username" />
      </span>
    )
  },
  {
  ...
  },
  {
    ...
    header: () => (
      <span>
        <Trans key="settings:_trn_status" />
      </span>
    )
  },
  {
  ...
  },
  {
    ...
    header: () => (
      <span>
        <Trans key="settings:_trn_actions" />
      </span>
    )
  }
]
...
const Accounts = () => {
  ...
  const deleteAccountContent = () => {
    if (validGDLUser()?.deletionTimeout) {
      return (
        <Trans
          key="settings:_trn_cannot_request_deletion_for_time"
          options={{
  ...
  return (
    <>
      <PageTitle>
        <Trans key="settings:_trn_accounts" />
      </PageTitle>
      <RowsContainer>
        <Row forceContentBelow>
          <Title>
            <Trans key="settings:_trn_gdl_account_title" />
          </Title>
            ...
            <Switch>
              <Match when={validGDLUser()}>
                <div class="flex flex-col gap-4">
                  <div class="flex items-center justify-between gap-2">
                    <div class="text-xl text-green-400">
                      <Trans key="settings:_trn_gdl_account_synced" />
                    </div>
                    ...
                    <Popover>
                      <PopoverTrigger>
                        <Button type="outline">
                          ...
                          <Trans key="settings:_trn_log_out_gdl_account" />
                        </Button>
                      </PopoverTrigger>
                      <PopoverContent>
                        <Button
                  ...
                  >
                    <div class="mb-4 flex items-center justify-between gap-8 rounded-md p-4 text-yellow-500 outline outline-yellow-500">
                      <div class="flex items-center gap-4">
                        ...
                        <Trans key="settings:_trn_gdl_account_not_verified" />
                      </div>
                      <Tooltip>
                        <TooltipTrigger>
                          <Button
                          ...
                          >
                            ...
                            <Trans key="settings:_trn_send_new_verification_email" />
                          </Button>
                        </TooltipTrigger>
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    ...
                    <GDLAccountRowItem
                      title={t("settings:_trn_friend_code")}
                      value={validGDLUser()?.friendCode}
                    />
                    <GDLAccountRowItem
                      title={t("settings:_trn_microsoft_username")}
                      value={
                    ...
                    />
                    <GDLAccountRowItem
                      title={t("settings:_trn_microsoft_oid")}
                      value={validGDLUser()?.microsoftOid}
                    />
                    <GDLAccountRowItem
                      title={t("settings:_trn_recovery_email")}
                    ...
                    />
                    <GDLAccountRowItem
                      title={t("settings:_trn_microsoft_email")}
                ...
                <div class="my-10 flex items-center gap-2 text-xl text-red-500">
                  ...
                  <Trans key="settings:_trn_danger_zone" />
                </div>
                <div class="text-lightSlate-700 flex items-center justify-between gap-12">
                  <div>
                    <Trans key="settings:_trn_request_account_deletion_description" />
                  </div>
                  <Tooltip>
                    <TooltipTrigger>
                      <Button
                      ...
                      >
                        ...
                        <Trans key="settings:_trn_request_account_deletion" />
                      </Button>
                    </TooltipTrigger>
              ...
              <Match when={!validGDLUser() && !invalidGDLUser()}>
                <div class="flex items-center justify-between gap-2">
                  <div class="text-xl text-red-400">
                    <Trans key="settings:_trn_gdl_account_not_synced" />
                  </div>
                  ...
                  >
                    ...
                    <Trans key="settings:_trn_link_gdl_account" />
                  </Button>
                </div>
              </Match>
              <Match when={invalidGDLUser()}>
                <div class="flex items-center justify-between gap-2">
                  <div class="text-xl text-yellow-400">
                    <Trans key="settings:_trn_gdl_account_error" />
                  </div>
      ...
      <RowsContainer>
        <Row forceContentBelow>
          <Title>
            <div class="flex items-center gap-4">
              <Trans key="settings:_trn_minecraft_accounts" />
              <Button
                type="secondary"
                size="small"
                onClick={() => {
