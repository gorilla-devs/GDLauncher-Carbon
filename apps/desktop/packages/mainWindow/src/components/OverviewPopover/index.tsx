        ...
        <div class="z-30 w-full flex-1 px-4">
          ...
          <div class="mt-4 flex w-full flex-1 flex-col items-start gap-2">
            <div class="text-lightSlate-700 flex items-start gap-2">
              <span class="flex items-center gap-2">
                ...
                <p class="text-lightSlate-100 m-0 text-sm">
                  <Trans key="modpacks:_trn_modpack.authors" />
                </p>
              </span>
            ...
            <div class="text-lightSlate-700 flex items-center gap-2">
              ...
              <p class="text-lightSlate-100 m-0 text-sm">
                <Trans key="modpacks:_trn_modpack.last_updated" />
              </p>
              <div class="whitespace-nowrap text-sm">
                <Trans
                  key="modpacks:_trn_modpack.last_updated_time"
                  options={{
            ...
            <div class="text-lightSlate-700 flex items-center gap-2">
              ...
              <p class="text-lightSlate-100 m-0 text-sm">
                <Trans key="modpacks:_trn_modpack.release_date" />
              </p>
              <div class="whitespace-nowrap text-sm">
                <Trans
                  key="modpacks:_trn_modpack.release_date_time"
                  options={{
                    time: formatDistanceToNowStrict(
            ...
            <div class="text-lightSlate-700 flex items-center gap-2">
              ...
              <p class="text-lightSlate-100 m-0 text-sm">
                <Trans key="modpacks:_trn_modpack.total_download" />
              </p>
              <div class="whitespace-nowrap text-sm">
            ...
            <div class="text-lightSlate-700 flex w-full items-center gap-2">
              ...
              <p class="text-lightSlate-100 m-0 text-sm">
                <Trans key="modpacks:_trn_modpack.mcVersion" />
              </p>
