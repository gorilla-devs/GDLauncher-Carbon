...
export function SearchableMultiSelect(props: SearchableMultiSelectProps) {
  ...
  const renderOption = (option: SearchableOption) => (
    ...
    >
      {/* Custom Checkbox */}
      <div class={`flex h-4 w-4 items-center justify-center rounded border border-darkSlate-500 flex-shrink-0 ${
        isSelected(option) ? "bg-primary-500 border-primary-500" : "bg-darkSlate-700"
      }`}>
