...
const EntityCard = (props: {
  ...
  return (
    <li
      ...
      } gap-2 shadow-md border-neutral-800 border-2 border-solid transform flex-col transition-transform hover:scale-105 hover:shadow-lg list-none flex items-center bg-opacity-60 backdrop-blur-lg justify-center  w-auto inline-block h-20 bg-gray-900`}
